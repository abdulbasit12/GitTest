...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style>
        ...
        #form table{width: 40%; display:inline-block!important;}
        #form table.price-persons{width:27.5%; margin-left:10px; float:right;}
        #form table tbody, #form table tbody tr, #form table tbody tr td{display:block;}
        .backdiv{margin-left:-410px; margin-top:-190px;}
        .add{display:inline-block; width:48%!important; float:left;}
        .submit{display:inline-block; width:48%!important; float:right; margin-top:0!important;}
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  >
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="DishName" runat="server" Width="150px" ></asp:TextBox>
                                                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="PricePerPerson" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-ForeColor="RoyalBlue"  >
                             ...
                             <ItemTemplate>
                                                                <asp:TextBox ID="dishPrice"  runat="server" TextMode="Number" Width="150px"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="MiniumPerson" HeaderStyle-HorizontalAlign="Center"  HeaderStyle-ForeColor="Orange"  >
                                                           
                             <ItemTemplate>
                                                                <asp:TextBox ID="MinPerson"  runat="server" TextMode="Number" Width="150px"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
